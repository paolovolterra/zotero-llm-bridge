...
- Reso pubblico il repository GitHub e verificato accesso anonimo al README. Pubblicato lo snapshot software 0.1.0 su Zenodo con DOI `10.5281/zenodo.22900667`; aggiornati README e metadati di citazione GitHub. Il flusso d'uso evidenziato è: ricerca online guidata da LLM durante lo studio → `references.bib` → riuso/import in Zotero tramite zlb.
- Chiarito l'obiettivo principale indicato dall'utente: l'LLM consiglia paper da leggere; zlb importa o collega i relativi PDF in una raccolta e l'utente li legge in Zotero. Il BibTeX traccia le fonti risolte e quelle ancora da recuperare.
